...
public class DuDaoSceneActivity extends HhBaseActivity implements ChooseImageViewBinder.OnChooseImageClickListener ,MessagePicturesLayout.Callback{
    private static final String TAG = DuDaoSceneActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dudao_scene);
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (code.equals("200")){
                        ...
                        Toast.makeText(DuDaoSceneActivity.this, "提交失败", Toast.LENGTH_SHORT).show();
    ...
    public void onImageAddClickListener(boolean add, Uri uri,String id) {
        if (add){
            ...
            rxPermissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.CAMERA)
                    .subscribe(new Observer<Boolean>() {
                        ...
                        public void onNext(Boolean aBoolean) {
                            ...
                            Matisse.from(DuDaoSceneActivity.this)
            ...
            String content = "";     //放评论
            ImagPagerUtil imagPagerUtil = new ImagPagerUtil(DuDaoSceneActivity.this, picList);
    ...
    private void postFireToService() {
        ...
        try {
            ...
            jsonObject.put("longitude", CommonData.lng);
            jsonObject.put("latitude",CommonData.lat);
        } catch (JSONException e) {
        }
        Log.e(TAG, "postFireToService: "+jsonObject);
        Log.e(TAG, "token: "+new DbConfig(this).getUser().getToken() );
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL +  "oa/api/SupervisorySystemDetail");
        params.setAsJsonContent(true);
        params.setBodyContent(jsonObject.toString());
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (code.equals("200")){
                        Toast.makeText(DuDaoSceneActivity.this, "上传成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }else {
                        Toast.makeText(DuDaoSceneActivity.this, message, Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                Toast.makeText(DuDaoSceneActivity.this, "请连接内网上传", Toast.LENGTH_SHORT).show();
            }
