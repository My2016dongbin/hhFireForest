...
public class WeiXingSettingActivity extends AppCompatActivity {
    private static final String TAG = WeiXingSettingActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wei_xing_setting);
        ...
        RxViewAction.clickNoDouble(findButton)
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        //   findFirePost();
                        gaojiDialog.hide();
                        Toast.makeText(WeiXingSettingActivity.this, "设置成功", Toast.LENGTH_SHORT).show();
                        updateSetting();
                    }
                });
                    ...
                    public void call(Void aVoid) {
                        ...
                        if (currentQuanxian == 0){
                            if (shengText.getText().toString().equals("请选择省")){
                                Toast.makeText(WeiXingSettingActivity.this, "请先选择省", Toast.LENGTH_SHORT).show();
                            }else {
