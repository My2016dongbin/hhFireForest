...
public class FireMissionInfoJMActivity extends HhBaseActivity implements INaviInfoCallback, SenceFooterViewBinder.OnSenceFooterItemClick {
    private static final String TAG = FireMissionInfoJMActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fire_mission_info_jm);
...
//启动导航组件
                        ...
                        AmapNaviPage.getInstance().showRouteActivity(getApplicationContext(), params, FireMissionInfoJMActivity.this);
                    }
                });
        /**
         * 开始任务
                ...
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        if (fireMission.getStatus() != 2){
                            ...
                            Toast.makeText(FireMissionInfoJMActivity.this, "任务已完成", Toast.LENGTH_SHORT).show();
                        }
...
//                        startActivity(intent);
    ...
    private void changeStateToService() {
        ...
        try {
            ...
            if (fireMission.getStatus() == 0){
                ...
                jsonObject.put("taskEndExecutionTime", endDate);
            }
    ...
    private void getDataFromService() {
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                hideDialogProgress(progressDialog);
                Log.e(TAG, "onSuccess: task " + result);
                try {
                ...
                try {
                    ...
                    if (jsonObject.getString("code").equals("200")) {
                        ...
                        try{
                            ...
                            View uploadView = LayoutInflater.from(FireMissionInfoJMActivity.this).inflate(R.layout.footer_sence, null);
                            RecyclerView rl_footer = uploadView.findViewById(R.id.rl_footer);
                            MyLinearLayoutManager linearLayoutManager = new MyLinearLayoutManager(FireMissionInfoJMActivity.this, LinearLayoutManager.VERTICAL, false);
                            ...
                            SenceFooterViewBinder senceFooterViewBinder = new SenceFooterViewBinder(FireMissionInfoJMActivity.this);
                            senceFooterViewBinder.setListener(FireMissionInfoJMActivity.this);
    ...
    public void videoClick(String video) {
        //视频预览
        Intent intent = new Intent(FireMissionInfoJMActivity.this, PlayerActivity.class);
