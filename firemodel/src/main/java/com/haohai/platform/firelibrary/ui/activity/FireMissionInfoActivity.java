...
//        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "oa/api/taskManagement/update");
    ...
    private void initFireData() {
        ...
        if (fireInfo.getPicPath2() == null || Objects.equals(fireInfo.getPicPath2(), "null")) {
    ...
    private void initData() {
        ...
        try{
            dizhiView.setText(fireMission.getTaskContent().replace("火情排查任务",""));
        }catch (Exception e){
