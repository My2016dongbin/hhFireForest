...
public class FireMissionInfoActivity extends HhBaseActivity implements INaviInfoCallback, SenceFooterViewBinder.OnSenceFooterItemClick {
    ...
    private ImageView image_four_view;
    private ImageView image_five_view;
    private ImageView image_six_view;
    ...
    private LinearLayout baojingLinearView;
    ...
    private void bindView() {
        ...
        //可见光视频
        RxViewAction.clickNoDouble(oneBodyKJGButton).subscribe(new Action1<Void>() {
            @Override
            public void call(Void unused) {
                Intent intent = new Intent(FireMissionInfoActivity.this, PlayerActivity.class);
                intent.putExtra("PLAYER_URL",fireInfo.getVideoPath1());
                intent.putExtra("PLAYER_NAME", fireInfo.getName());
                startActivity(intent);
            }
        });
        //热成像视频
        RxViewAction.clickNoDouble(oneBodyRCXButton).subscribe(new Action1<Void>() {
            @Override
            public void call(Void unused) {
                Intent intent = new Intent(FireMissionInfoActivity.this, PlayerActivity.class);
                intent.putExtra("PLAYER_URL",fireInfo.getVideoPath2());
                intent.putExtra("PLAYER_NAME", fireInfo.getName());
                startActivity(intent);
            }
        });
...
//                        startActivity(intent);
    ...
    private void initView() {
        ...
        baojingLinearView = (LinearLayout) findViewById(R.id.fire_linear);
        baojingLinearView.setVisibility(View.GONE);
        ...
        image_four_view = (ImageView) findViewById(R.id.image_four_view);
        image_five_view = (ImageView) findViewById(R.id.image_five_view);
        image_six_view = (ImageView) findViewById(R.id.image_six_view);
    ...
    private void changeStateToService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "oa/api/taskManagement");//PUT//
//        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "oa/api/taskManagement/update");
...
//        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "oa/api/taskManagement/update");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (jsonObject.getString("code").equals("200")) {
                        ...
                        initFireData();
                        baojingLinearView.setVisibility(View.VISIBLE);
                    }else {
                     //   Toast.makeText(FireMissionInfoActivity.this, "数据获取失败", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void initFireData() {
        ...
        dizhiDialogView.setText(fireInfo.getAddress());
        ...
        if (fireInfo.getVideoPath1() == null|| Objects.equals(fireInfo.getVideoPath1(), "")) {
        ...
        if (fireInfo.getVideoPath2() == null|| Objects.equals(fireInfo.getVideoPath2(), "")) {
    ...
    private void initData() {
        ...
        if (imgArray.length==1){
            ...
            imageTwoView.setVisibility(View.VISIBLE);
            imageThreeView.setVisibility(View.VISIBLE);
            image_four_view.setVisibility(View.VISIBLE);
            Glide.with(getApplicationContext()).load(imgArray[0]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(imageOneView);
            Glide.with(getApplicationContext()).load(imgArray[1]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(imageTwoView);
            Glide.with(getApplicationContext()).load(imgArray[2]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(imageThreeView);
            Glide.with(getApplicationContext()).load(imgArray[3]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(image_four_view);
        }else if (imgArray.length==5){
            imageOneView.setVisibility(View.VISIBLE);
            imageTwoView.setVisibility(View.VISIBLE);
            imageThreeView.setVisibility(View.VISIBLE);
            image_four_view.setVisibility(View.VISIBLE);
            image_five_view.setVisibility(View.VISIBLE);
            Glide.with(getApplicationContext()).load(imgArray[0]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(imageOneView);
            Glide.with(getApplicationContext()).load(imgArray[1]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(imageTwoView);
            Glide.with(getApplicationContext()).load(imgArray[2]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(imageThreeView);
            Glide.with(getApplicationContext()).load(imgArray[3]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(image_four_view);
            Glide.with(getApplicationContext()).load(imgArray[4]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(image_five_view);
            ...
            image_four_view.setVisibility(View.VISIBLE);
            image_five_view.setVisibility(View.VISIBLE);
            image_six_view.setVisibility(View.VISIBLE);
            Glide.with(getApplicationContext()).load(imgArray[0]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(imageOneView);
            Glide.with(getApplicationContext()).load(imgArray[1]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(imageTwoView);
            Glide.with(getApplicationContext()).load(imgArray[2]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(imageThreeView);
            Glide.with(getApplicationContext()).load(imgArray[3]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(image_four_view);
            Glide.with(getApplicationContext()).load(imgArray[4]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(image_five_view);
            Glide.with(getApplicationContext()).load(imgArray[5]).placeholder(R.drawable.ic_jaizai).error(R.drawable.ic_no_pic).into(image_six_view);
        }
    }
    @Override
