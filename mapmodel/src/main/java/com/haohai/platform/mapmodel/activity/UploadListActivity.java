...
import com.haohai.platform.mapmodel.multitype.UploadPostViewBinder;
...
public class UploadListActivity extends HhBaseActivity implements UploadPostViewBinder.OnPicClick {
    ImageView iv_back;
    ImageView iv_right;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RxViewAction.clickNoDouble(iv_right).subscribe(new Action1<Void>() {
            @Override
            public void call(Void unused) {
                startActivity(new Intent(UploadListActivity.this,UploadActivity.class));
            }
        });
    ...
    private void initView() {
        ...
        UploadPostViewBinder binder = new UploadPostViewBinder();
        binder.setListener(this,this);
        adapter.register(UploadPost.class,binder);
    ...
    List<UploadPost> modelList = new ArrayList<>();
    private void initData() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "api/taskManagement/page");
                ...
                try {
                    ...
                    if(jsonObject.getInt("code") == 200) {
                        ...
                        for (int i = 0; i < dataList.length(); i++) {
                            modelList.add(gson.fromJson(dataList.get(i).toString(),UploadPost.class));
                        }
                        updateListView();
                    }
    ...
    public void OnPicClickListener(String picUrl) {
        Intent intent = new Intent(UploadListActivity.this, Pic1Activity.class);
        intent.putExtra("pic",picUrl);
        intent.putExtra("from",UploadListActivity.class);
        startActivity(intent);
    }
    @Override
    public void OnVideoClickListener(String videoUrl) {
        Intent intent = new Intent(UploadListActivity.this, PlayerActivity.class);
