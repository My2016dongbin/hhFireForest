...
import com.ruyiruyi.rylibrary.base.IMActivity;
    ...
    private void bindView() {
        ...
        RxViewAction.clickNoDouble(im_layout).subscribe(new Action1<Void>() {
            ...
            public void call(Void aVoid) {
                ...
                getActivity().startActivity(new Intent(getActivity(), IMActivity.class));
            }
        });
...
//                        postIsReleaseFireToService();
    ...
    private void initView() {
        ...
        /*im_layout.setVisibility(View.GONE);//TODO 屏蔽*/
        im_button = ((TextView) getView().findViewById(R.id.im_button));
...
//        });
    ...
    private void initQuyuBianjie() {
        ...
        districtSearchOption.cityName("滨州市");//检索城市名称
        districtSearchOption.districtName("邹平");//检索的区县名称
