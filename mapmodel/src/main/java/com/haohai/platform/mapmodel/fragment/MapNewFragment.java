...
//                        gugeGaochengText.setTextColor(getResources().getColor(R.color.c7));
    ...
    private void initView() {
        ...
        flyBaiduMapZoom( 33.686892618279764,111.499323483305076,13);//默认位置
...
//        });
    ...
    private void initQuyuBianjie() {
        //网格数据json解析
        try {
            JSONObject jsonObject = new JSONObject(new GetJsonDataUtil().getJson(getActivity(),"xixia.json"));
    ...
    private void initQuyuBianjieOld() {
        ...
        districtSearchOption.cityName("西峡");//检索城市名称
