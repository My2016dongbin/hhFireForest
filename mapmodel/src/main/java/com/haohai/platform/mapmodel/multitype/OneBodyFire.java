...
public class OneBodyFire {
    ...
    private String fireMonitorPointDistance;

    private String fireMonitorPointDirection;
    ...
    public String getFireMonitorPointDistance() {
        return fireMonitorPointDistance;
    }

    public void setFireMonitorPointDistance(String fireMonitorPointDistance) {
        this.fireMonitorPointDistance = fireMonitorPointDistance;
    }

    public String getFireMonitorPointDirection() {
        return fireMonitorPointDirection;
    }

    public void setFireMonitorPointDirection(String fireMonitorPointDirection) {
        this.fireMonitorPointDirection = fireMonitorPointDirection;
    }
