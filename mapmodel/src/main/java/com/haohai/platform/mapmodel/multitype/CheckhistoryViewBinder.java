 ...
 */
public class CheckhistoryViewBinder extends ItemViewProvider<historylist.ChildFirejd, CheckhistoryViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull final ViewHolder holder, @NonNull final historylist.ChildFirejd ChildFirejd) {
        Log.e("TAG", "onBindViewHolder: "+ChildFirejd.getCode() );
        switch (ChildFirejd.getCode()){
        ...
        holder.nameView.setText(ChildFirejd.getCode());
        if (ChildFirejd.getStatus() == 2){
