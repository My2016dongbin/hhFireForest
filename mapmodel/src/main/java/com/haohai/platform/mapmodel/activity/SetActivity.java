...
public class SetActivity extends FullBaseActivity {
    ...
    public boolean isChooseChixu = false;
        ...
        RxViewAction.clickNoDouble(baojingSettingLayout)
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        ...
                        DbConfig dbConfig = new DbConfig(SetActivity.this);
    ...
    private void initGaojiView() {
        ...
        chixuText = ((TextView) gaojiInflater.findViewById(R.id.chixubaojing_view));
        ...
        RxViewAction.clickNoDouble(chixuText)
                .subscribe(new Action1<Void>() {
                    @Override
                    public void call(Void aVoid) {
                        if (isChooseChixu){
                            isChooseChixu = false;
                            chixuText.setBackgroundResource(R.drawable.bg_text_hui);
                            chixuText.setTextColor(getResources().getColor(R.color.c6));
                        }else {
                            isChooseChixu = true;
                            chixuText.setBackgroundResource(R.drawable.bg_text_lan);
                            chixuText.setTextColor(getResources().getColor(R.color.c12));
                        }
                    }
                });
                    ...
                    public void call(Void aVoid) {
                        ...
                        if (currentQuanxian == 0){
                            if (shengText.getText().toString().equals("请选择省")){
                                Toast.makeText(SetActivity.this, "请先选择省", Toast.LENGTH_SHORT).show();
                            }else {
