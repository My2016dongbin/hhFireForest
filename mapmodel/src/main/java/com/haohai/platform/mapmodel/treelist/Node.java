package com.haohai.platform.mapmodel.treelist;
...
public class Node<T> {
    ...
    public Node(String id, String pid, String name,String apiUrl) {
        this.id = id;
        this.pid = pid;
        this.name = name;
        this.apiUrl=apiUrl;
    ...
    public Node(String id, String pid, T data, String name,String apiUrl) {
        this.id = id;
        this.pid = pid;
        this.data = data;
        this.name = name;
