...
public class GridTrees {
    ...
    List<GridPointModel> monitorDetailVOs;
    ...
    public List<GridPointModel> getMonitorDetailVOs() {
        return monitorDetailVOs;
    }

    public void setMonitorDetailVOs(List<GridPointModel> monitorDetailVOs) {
