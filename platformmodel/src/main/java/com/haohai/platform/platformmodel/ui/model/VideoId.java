...
public class VideoId {
    ...
    public VideoId(String controlControlId,String controlMonitorId,String monitorId,String serial,String videoId, String videoName, int videoPlayer,String url) {
