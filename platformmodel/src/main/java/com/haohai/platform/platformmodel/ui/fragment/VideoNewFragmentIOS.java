...
public class VideoNewFragmentIOS extends HhBaseFragment {
     ...
     * @param playerUrl url
     */
    private void addVideoPlayer(String playerUrl,String id) {
        if (currentChooseVideo == 1) {
            video1AddView.setVisibility(View.GONE);
            video1Player.setVisibility(View.VISIBLE);
            video1Player.setUpLazy(playerUrl, true, null, null, currentClickItemName);
            ...
            video2Player.setUpLazy(playerUrl, true, null, null, currentClickItemName);
            ...
            video3Player.setUpLazy(playerUrl, true, null, null, currentClickItemName);
            ...
            video4Player.setUpLazy(playerUrl, true, null, null, currentClickItemName);
            ...
            video5Player.setUpLazy(playerUrl, true, null, null, currentClickItemName);
            ...
            video6Player.setUpLazy(playerUrl, true, null, null, currentClickItemName);
            ...
            video7Player.setUpLazy(playerUrl, true, null, null, currentClickItemName);
            ...
            video8Player.setUpLazy(playerUrl, true, null, null, currentClickItemName);
            ...
            video9Player.setUpLazy(playerUrl, true, null, null, currentClickItemName);
     ...
     * @param playerUrl url
     */
    private void setVideoPlayer(String playerUrl,String id) {
