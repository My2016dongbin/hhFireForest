...
public class MyFragment extends HhBaseFragment {
    ...
    private TextView bumen_view;
    private TextView dianhua_view;
    ...
    private void initView() {
        bumen_view = ((TextView) getView().findViewById(R.id.bumen_view));
        dianhua_view = ((TextView) getView().findViewById(R.id.dianhua_view));
        ...
        nameView.setText((user.getFullName()+"").replace("null",""));
        bumen_view.setText((user.getGridName()+"").replace("null",""));
        dianhua_view.setText((user.getPhone()+"").replace("null",""));
