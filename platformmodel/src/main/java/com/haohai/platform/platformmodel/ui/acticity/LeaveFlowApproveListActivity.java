...
public class LeaveFlowApproveListActivity extends HhBaseActivity {
    private static final String TAG = LeaveFlowApproveListActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leave_flow_approve_list);
    ...
    private void getDataFromService() {
        ...
        RequestParams params = new RequestParams(RequestUtils.REQUEST_URL + "api/process/selectIApprovalProcess");
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (code.equals("200")){
                        ...
                        Toast.makeText(LeaveFlowApproveListActivity.this, "获取失败", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void initView() {
            ...
            public void onItemClick(int var1) {
                switch ((var1)) {
                    case -1:
                        ...
                        break;
                    case -2:
                        startActivityForResult(new Intent(getApplicationContext(),LeaveFlowAddActivity.class), RequestCode.LIST_CHANGE);
                        break;
                }
            }
        });
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.leave_approvel_refresh_layout);
        swipeRefreshLayout.setProgressViewEndTarget(true, 200);

        /**
         * 第一步  创建列表对象
         */
        listView = (RecyclerView) findViewById(R.id.leave_approvel_listview);
        //加载更多
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);       // LinearLayoutManager.VERTICAL  竖向布局   LinearLayoutManager.HORIZONTAL,横向布局
