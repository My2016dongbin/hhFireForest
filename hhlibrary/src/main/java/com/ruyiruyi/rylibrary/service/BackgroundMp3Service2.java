...
public class BackgroundMp3Service2 extends Service {
    private static final String TAG = BackgroundMp3Service2.class.getSimpleName();
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    BackgroundMp3Service2.this.onDestroy();
                    break;
            }
        }
    };
