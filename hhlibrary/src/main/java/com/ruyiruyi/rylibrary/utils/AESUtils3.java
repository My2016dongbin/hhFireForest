...
//        byte[] decoded = com.haohaiencode.commons.codec.binary.Base64.decodeBase64(rsaKey);
...
//        String outStr = com.haohaiencode.commons.codec.binary.Base64.encodeBase64String(cipher.doFinal(str.getBytes("UTF-8")));
    ...
    public static byte[] encryptByPublicKey(byte[] data, String publicKey) throws Exception {
        ...
        Key publicK = KeyFactory.getInstance("RSA").generatePublic(new X509EncodedKeySpec(com.haohaiencode.commons.codec.binary.Base64.decodeBase64(publicKey)));
     ...
     */
        ...
        //分段进行加密操作
        return encryptAndDecryptOfSubsection(data, cipher, 128);
    }
