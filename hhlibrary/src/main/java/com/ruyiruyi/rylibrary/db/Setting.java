...
public class Setting {
    ...
    public Setting(int id, String weixing, String tiankong, String dimian, String dimao, String number, String jingwai, String huanchong, String chixu) {
        this.id = id;
        this.weixing = weixing;
        this.tiankong = tiankong;
        this.dimian = dimian;
    ...
    public void setChixu(String chixu) {
        this.chixu = chixu;
    }
