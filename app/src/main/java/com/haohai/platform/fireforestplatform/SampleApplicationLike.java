...
public class SampleApplicationLike extends DefaultApplicationLike {
    ...
    public void onCreate() {
        ...
        // 调试时，将第三个参数改为true
        Bugly.init(getApplication(), "91c90c0246", true);
        ...
        ARouter.init(getApplication()); // As early as possible, it is recommended to initialize in the Application

        getAllActivities(getApplication());
        ...
        // 2、相关Service调用
        //  }
        DaemonEnv.initialize(getApplication(), TraceServiceImpl.class,DaemonEnv.DEFAULT_WAKE_UP_INTERVAL);
    ...
    private void initTengxunTuisong() {
        ...
        //开启小米推送
        XGPushConfig.setMiPushAppId(getApplication(), "2882303761518845436");
        XGPushConfig.setMiPushAppKey(getApplication(), "5981884523436");

        //oppo推送
        XGPushConfig.setOppoPushAppId(getApplication(), "93a4e3e3bcb3448387c2af2eadc1f4ee");
        XGPushConfig.setOppoPushAppKey(getApplication(), "e317f095327f4ca0bf3f2837f9fece03");
        ...
        //设置魅族APPID和APPKEY
        XGPushConfig.setMzPushAppId(getApplication(), "136981");
        XGPushConfig.setMzPushAppKey(getApplication(), "ae5633cd5a4146a1832b7cc3caa4d205");
