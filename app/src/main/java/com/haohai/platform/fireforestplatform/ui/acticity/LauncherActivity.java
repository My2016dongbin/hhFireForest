                 ...
                 //     Log.e(TAG, "handleMessage: " + user.getIsLogin());
                    if (user == null){      //用户不存在
                        ...
                        if (user.getIsLogin() == 0) {       //用户未登录
                            ...
                            CommonData.earlyHour = user.getEarlyHour();
                            CommonData.earlyMinute = user.getEarlyMinute();
                            CommonData.nightHour = user.getNightHour();
                            CommonData.nightMinute = user.getNightMinute();
                            if(user.getWorkDayList()!=null && !user.getWorkDayList().isEmpty()){
                                CommonData.workDayList = Arrays.asList(user.getWorkDayList().split(","));
                            }
