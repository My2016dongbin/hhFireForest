...
import com.haohai.platform.mapmodel.activity.SignListActivity;
...
//                        Intent intent = new Intent(getApplicationContext(), SignMonthActivity.class);
...
//                            Intent intent = new Intent(getApplicationContext(), SignMonthActivity.class);
    ...
    private void requestPower() {
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            //AuthTypeUtil.checkNetworkConnectivity(LauncherActivity.this);VPN功能
            clockPermission();
        }
    }
