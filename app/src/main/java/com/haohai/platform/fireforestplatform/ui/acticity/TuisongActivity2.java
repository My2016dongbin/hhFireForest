...
public class TuisongActivity2 extends AppCompatActivity {

    private static final int GO_GUIDE = 101;
    private static final String TAG = TuisongActivity2.class.getSimpleName();
    ...
    private void requestPower() {
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                Toast.makeText(TuisongActivity2.this, "1111", Toast.LENGTH_SHORT).show();
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                if (ex.toString().contains("400")) {
                    Toast.makeText(TuisongActivity2.this, "密码错误", Toast.LENGTH_SHORT).show();
                }else  if (ex.toString().contains("401")) {
                    Toast.makeText(TuisongActivity2.this, "账号不存在", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(TuisongActivity2.this, "网络异常", Toast.LENGTH_SHORT).show();
                }
