        ...
        RxViewAction.clickNoDouble(loginButton)
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        ...
                        im.hideSoftInputFromWindow(userNameEdit.getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
                        InputMethodManager im2 = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                        im2.hideSoftInputFromWindow(passwordEdit.getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
                        loginToService();
                    }
                });
