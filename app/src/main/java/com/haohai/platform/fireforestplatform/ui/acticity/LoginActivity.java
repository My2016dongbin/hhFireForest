...
public class LoginActivity extends HhBaseActivity {
        ...
        RxViewAction.clickNoDouble(loginButton)
                .subscribe(new Action1<Void>() {
                    ...
                    public void call(Void aVoid) {
                        closeKeybord(LoginActivity.this);
                        loginToService();
                    }
                });
                ...
                try {
                    ...
                    if (code.equals("200")){
                        ...
                        try {
                            ...
                            db.delete(Grid.class);
                            db.saveOrUpdate(user);
                            SharedPreferences.Editor editor = LoginActivity.this.getSharedPreferences("data", 0).edit();
                            editor.putString("grid", "");
                            editor.apply();
                        } catch (DbException e) {
                            e.printStackTrace();
                        }
    ...
    private void initGridIntoDb() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                Log.e(TAG, "onSuccess Grid------ " + result);
                try {
                    ...
                    if (code.equals("200")){
                        ...
                        Log.e(TAG, "onSuccess Grid: " +gridList.size() );
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                Toast.makeText(LoginActivity.this, "网格信息获取失败", Toast.LENGTH_SHORT).show();
            }
