            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (code.equals("200")){
                        ...
                        User user = new User(id, userCode,userNameEdit.getText().toString(), passwordEdit.getText().toString(), fullName,jobTitle, email, phone, sex, entryTime, birthday, type, isSuperAdmin, comment, groupId,
